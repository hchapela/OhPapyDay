...
(function e(t, n, r) {
  ...
  1: [function (require, module, exports) {
    module.exports = class Result {
      ...
      initSentences() {
        this.sentences = ["La vieillesse arrive brusquement, comme la neige. Un matin au réveil, on s'aperçoit que tout est blanc. Jules Renard", "Le travail de la jeunesse fait le repos de la vieillesse. Proverbe Grec Antique.", "La jeunesse a une belle face et la vieillesse une belle âme. Proverbe Suédois", "Le plus bel âge de l'amitié est la vieillesse. Proverbe Français", "La jeunesse est le temps d'étudier la sagesse, la vieillesse est le temps de la pratiquer. Jean Jacques Rousseau", "La vieillesse bien comprise est l'âge de l'espérance. Victor Hugo", "La jeunesse est une ivresse sans vin et la vieillesse un vin sans ivresse. Proverbe Allemand"];
      }
    ...
    */
    ...
    class Game {
      constructor() {
        ...
        this.$papy = this.$statuses.querySelector('.js-papy'); // Sounds
      ...
      tick() {
        ...
        this.checkCoolDown(); // change papy's head

        this.changePapy(); // Make the final score
      ...
      changePapy() {
        if (this.bored + this.difficulty > 66 || this.tired + this.difficulty > 66 || this.lonely + this.difficulty > 66) {
          this.$papy.src = 'img/papy-sad.png';
        } else if (this.bored + this.difficulty > 33 || this.tired + this.difficulty > 33 || this.lonely + this.difficulty > 33) {
